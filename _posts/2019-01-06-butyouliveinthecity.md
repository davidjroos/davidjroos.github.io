...
Any complaint along these lines is treated as NIMBY-ism, with a quizzical expression appearing on any face as they assume that I am demanding pitch black, dead silent nights and a dead city that can't function in case poor little me is disturbed. I was representing a residential perspective at a recent Auckland Transport run workshop on servicing the city centre (loading, deliveries, commercial activities). In the brainstorming session I suggested that noise associated with 24/7 operation (as was proposed) would need to factor in at least some consideration for residents. The usual line was blurted out, assuming my flat out opposition, a straw man position, rather than considering that there are likely some simple things that can be done so minimise what is completely needless noise pollution. Avoiding the need to (beep beep beep) reverse, the use of smaller and\or electric vehicles, driver training, design of access and contractor guidelines. Nothing that prevents anything, nothing unreasonable, just some simple considerations for others, instead of a selfish assumption that only business needs mattered.
...
A complaint about concrete cutting starting at 10pm and going until 2am on a Sunday was responded to with details that the resource consent allows it because it would be too disruptive to business to do it any other time. My needs, and the needs of hundreds or thousands living within a few hundred meters are not relevant until we get to our workplaces tomorrow, at which point we suddenly become very important. Real people, just lIke that! A calculation was made and you are not valuable until you are generating profit.

This one is easy to fix - communicate with neighbours about the need for the work and justify it. Tell us when it will start, when it will end and and who to contact if and when breaches to their consent conditions occur. Overall, less people are disturbed if you do it in the middle of the night, I get that, but the magnitude of disturbance is not equal. The basic needs that all humans have need to be factored in. 1000 people disturbed while working with a 100db sound with a noise floor of 70db is quite different to 500 disturbed while sleeping with 100db noise with a 40db noise floor. Any time there is a compromise, it is the residents that take all the negative. That's not a compromise,that's a clear message being sent.

A road that had been completely closed for months was repainted at 11pm on a Sunday so it won't interfere with traffic. "Oh, it's very quiet", except you can hear it in your apartment on the 17th floor through double glazed windows. And it could have been done at any time of the day on any day of the week, because the road was already closed. The person approving this work may well have been you, now moving from a position of uncaring to active malice.

This one is also easy to fix. Don't assume you know how loud anything is, and think about the number of people any single nuisance will impact.
